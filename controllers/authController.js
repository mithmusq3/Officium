...
//Handle Errors function
    ...
    if (err.code === 11000) {
        errors.email = 'This email/(mobile number) is already registered';
        return errors;
    }
...
// POST FUNCTIONS
    ...
    // User functions
        ...
        const { name, email, gender, birthday, number, password, no_offer } = req.body;
        
        try{
                const user = await User.create({ name, email, gender, birthday, number, password, no_offer });
                //create a jwt
